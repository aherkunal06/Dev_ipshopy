<?php
class ModelVendorCancelledOrders extends Model {
    public function getTotalCancelledOrders($vendor_id, $data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id = '" . (int)$vendor_id . "' AND order_status_id = '7'";
    ...
    public function getCancelledOrders($vendor_id, $data = array()) {
