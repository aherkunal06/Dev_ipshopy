<?php
class ModelVendorUndeliveredOrders extends Model {
    public function getTotalUndeliveredOrders($vendor_id, $data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id = '" . (int)$vendor_id . "' AND order_status_id = '20'";
    ...
    public function getUndeliveredOrders($vendor_id, $data = array()) {
