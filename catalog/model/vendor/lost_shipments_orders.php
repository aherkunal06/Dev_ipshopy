<?php
class ModelVendorLostShipmentsOrders extends Model {
    public function getTotalLostShipmentsOrders($vendor_id, $data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id = '" . (int)$vendor_id . "' AND order_status_id = '39'";
    ...
    public function getLostShipmentsOrders($vendor_id, $data = array()) {
