<?php
class ModelVendorShippedOrders extends Model {
    public function getTotalShippedOrders($vendor_id, $data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id = '" . (int)$vendor_id . "' AND order_status_id = '3'";
    ...
    public function getShippedOrders($vendor_id, $data = array()) {
