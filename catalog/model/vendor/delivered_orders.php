<?php
class ModelVendorDeliveredOrders extends Model {
    public function getTotalDeliveredOrders($vendor_id, $data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id = '" . (int)$vendor_id . "' AND order_status_id = '18'";
    ...
    public function getDeliveredOrders($vendor_id, $data = array()) {
