<?php
class ModelVendorRtoInTransitOrders extends Model {
    public function getTotalRtoInTransitOrders($vendor_id, $data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id = '" . (int)$vendor_id . "' AND order_status_id = '38'";
    ...
    public function getRtoInTransitOrders($vendor_id, $data = array()) {
