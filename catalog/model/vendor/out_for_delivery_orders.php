<?php
class ModelVendorOutForDeliveryOrders extends Model {
    public function getTotalOutForDeliveryOrders($vendor_id, $data = array()) {
        $sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id = '" . (int)$vendor_id . "' AND order_status_id = '25'";
    ...
    public function getOutForDeliveryOrders($vendor_id, $data = array()) {
