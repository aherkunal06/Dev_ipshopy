<?php 
class ModelCatalogHomeDiwali extends Model {

    public function getCategoryInfoWithPriceAndRating($category_ids = []) {
    ...
    $sql = "SELECT 
            ...
            LEFT JOIN " . DB_PREFIX . "review r
                ...
                AND r.status = '1'
            WHERE c.category_id IN (" . $ids_list . ")
            GROUP BY c.category_id, cd.name, c.image
            ORDER BY FIELD(c.category_id, " . $ids_list . ")";
