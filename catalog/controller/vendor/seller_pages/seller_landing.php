<?php
class Controllervendorsellerpagessellerlanding extends Controller {
	public function index() {
        $this->load->language('vendor/seller_pages/seller_landing');
...
$data['header'] = $this->load->controller('vendor/seller_pages/header');
		...
		$this->response->setOutput($this->load->view('vendor/seller_pages/seller_landing', $data));
