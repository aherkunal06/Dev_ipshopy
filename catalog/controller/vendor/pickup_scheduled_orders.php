<?php
class ControllerVendorPickupScheduledOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/pickup_scheduled_orders');
    ...
    public function pickupscheduledview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/pickup_scheduled_orders');
		...
		$this->response->setOutput($this->load->view('vendor/pickup_scheduled_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/pickup_scheduled_orders', '', true))
        );

        $data['pickup_scheduled_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_pickup_scheduled_orders->getTotalPickupScheduledOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_pickup_scheduled_orders->getPickupScheduledOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['pickup_scheduled_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/pickup_scheduled_orders/pickupscheduledview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/pickup_scheduled_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/pickup_scheduled_orders', $data));
    }
}
?>
