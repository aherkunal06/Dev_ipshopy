<?php
class ControllerVendorReturnOrders extends Controller {
    private $error = array();
    ...
    public function returnview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/return_orders');
		...
		$this->response->setOutput($this->load->view('vendor/return_orders_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/return_orders', '', true))
        );
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_return_orders->getTotalReturnOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_return_orders->getReturnOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['return_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/return_orders/returnview', 'order_id=' . $result['order_id'], true),
                //-- added code changes for product return  on 20-05-2025 --
                'viewImages' => $this->url->link('vendor/return_images', 'return_ids=' . $result['return_id'], true),
                'requestForClaim' => $this->url->link('vendor/claim/vendor_claim_form', 'return_ids=' . $result['return_id'], true),
        ...
        $pagination->url = $this->url->link('vendor/return_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/return_orders', $data));
    }
}
?>
