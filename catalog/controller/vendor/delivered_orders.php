<?php
class ControllerVendorDeliveredOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/delivered_orders');
    ...
    public function deliveredview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/delivered_orders');
		...
		$this->response->setOutput($this->load->view('vendor/delivered_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/delivered_orders', '', true))
        );

        $data['delivered_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_delivered_orders->getTotalDeliveredOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_delivered_orders->getDeliveredOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['delivered_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/delivered_orders/deliveredview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/delivered_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/delivered_orders', $data));
    }
}
?>
