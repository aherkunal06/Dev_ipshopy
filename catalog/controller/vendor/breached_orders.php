<?php
class ControllerVendorBreachedOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/breached_orders');
    ...
    public function breachedview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/breached_orders');
		...
		$this->response->setOutput($this->load->view('vendor/breached_orders_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/breached_orders', '', true))
        );

        $data['breached_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_breached_orders->getTotalBreachedOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_breached_orders->getBreachedOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['breached_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/breached_orders/breachedview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/breached_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/breached_orders', $data));
    }
}
?>
