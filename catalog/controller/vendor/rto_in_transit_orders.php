<?php
class ControllerVendorRtoInTransitOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/rto_in_transit_orders');
    ...
    public function rtointransitview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/rto_in_transit_orders');
		...
		$this->response->setOutput($this->load->view('vendor/rtointransit_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/rto_in_transit_orders', '', true))
        );

        $data['rto_in_transit_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_rto_in_transit_orders->getTotalRtoInTransitOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_rto_in_transit_orders->getRtoInTransitOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['rto_in_transit_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/rto_in_transit_orders/rtointransitview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/rto_in_transit_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/rto_in_transit_orders', $data));
    }
}
?>
