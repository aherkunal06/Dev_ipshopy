...
class ControllerVendorTodaysOrder extends Controller
{
    public function index()
    {
        ...
        $this->load->language('vendor/todays_order');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->load->model('vendor/todays_order');
    ...
    public function todayview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/todays_order');
		...
		$this->response->setOutput($this->load->view('vendor/todays_view', $data));
	}
    ...
    protected function getList()
    {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/todays_order', '', true))
        );

        $data['todays_order'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_todays_order->getTotalTodaysOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_todays_order->getTodaysOrders($vendor_id, $filter_data);
        $sr = 1;
        foreach ($results as $result) {
            $image = 'no_image.png';
            ...
            $data['todays_order'][] = array(
                ...
                'view' => $this->url->link('vendor/todays_order/todayview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/todays_order', $url . '&page={page}', true);
        ...
        // var_dump($data['todays_order']);

        $this->response->setOutput($this->load->view('vendor/todays_order', $data));
    }
}
