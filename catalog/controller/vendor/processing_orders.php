<?php
class ControllerVendorProcessingOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/processing_orders');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->load->model('vendor/processing_orders');
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/processing_orders', '', true))
        );
        ...
        $order_total = $this->model_vendor_processing_orders->getTotalProcessingOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_processing_orders->getProcessingOrders($vendor_id, $filter_data);
        ...
        $pagination->url = $this->url->link('vendor/processing_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/processing_orders', $data));
    }
}
?>
