<?php
class ControllerVendorCompleteOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/complete_orders');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->load->model('vendor/complete_orders');
    ...
    public function completeview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/complete_orders');
		...
		$this->response->setOutput($this->load->view('vendor/complete_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/complete_orders', '', true))
        );

        $data['complete_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_complete_orders->getTotalCompleteOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_complete_orders->getCompleteOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['complete_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/complete_orders/completeview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/complete_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/complete_orders', $data));
    }
}
?>
