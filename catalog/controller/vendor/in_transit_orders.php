<?php
class ControllerVendorInTransitOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/in_transit_orders');
    ...
    public function intransitview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/in_transit_orders');
		...
		$this->response->setOutput($this->load->view('vendor/in_transit_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/in_transit_orders', '', true))
        );

        $data['in_transit_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_in_transit_orders->getTotalInTransitOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_in_transit_orders->getInTransitOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['in_transit_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/in_transit_orders/intransitview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/in_transit_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/in_transit_orders', $data));
    }
}
?>
