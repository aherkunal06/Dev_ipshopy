<?php
class ControllerVendorShippedOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/shipped_orders');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->load->model('vendor/shipped_orders');

        $this->getList();
    }
    
    public function shippedview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/shipped_orders');
		...
		$this->response->setOutput($this->load->view('vendor/shipped_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/shipped_orders', '', true))
        );
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_shipped_orders->getTotalShippedOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_shipped_orders->getShippedOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['shipped_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/shipped_orders/shippedview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/shipped_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/shipped_orders', $data));
    }
}
?>
