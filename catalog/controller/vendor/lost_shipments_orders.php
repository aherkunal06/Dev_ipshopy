<?php
class ControllerVendorLostShipmentsOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/lost_shipments_orders');
    ...
    public function lostshipmentview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/lost_shipments_orders');
		...
		$this->response->setOutput($this->load->view('vendor/lost_shipment_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/lost_shipments_orders', '', true))
        );

        $data['lost_shipments_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_lost_shipments_orders->getTotalLostShipmentsOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_lost_shipments_orders->getLostShipmentsOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['lost_shipments_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/lost_shipments_orders/lostshipmentview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/lost_shipments_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/lost_shipments_orders', $data));
    }
}
?>
