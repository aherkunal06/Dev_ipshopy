<?php
class ControllerVendorUndeliveredOrders extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/undelivered_orders');
    ...
    public function undeliveredview()
	{
		...
		$data['cancel'] = $this->url->link('vendor/undelivered_orders');
		...
		$this->response->setOutput($this->load->view('vendor/undelivered_view', $data));
	}
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/undelivered_orders', '', true))
        );

        $data['undelivered_orders'] = array();
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_undelivered_orders->getTotalUndeliveredOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_undelivered_orders->getUndeliveredOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['undelivered_orders'][] = array(
                ...
                'view' => $this->url->link('vendor/undelivered_orders/undeliveredview', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/undelivered_orders', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/undelivered_orders', $data));
    }
}
?>
