<?php
class ControllerVendorOrderHistory extends Controller {
    private $error = array();
    ...
    public function index() {
        ...
        $this->load->language('vendor/order_history');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->load->model('vendor/order_history');
    ...
    public function order_history_View() {
		...
		$data['cancel'] = $this->url->link('vendor/order_history', 'user_token=' . $this->session->data['user_token'], true);
        ...
        $data['column_GSTIN']		= $this->language->get('column_GSTIN');
		...
		if (!empty($order_info)) {
            ...
            // FIX: Get total order histories for pagination
            ...
            $pagination->url = $this->url->link('vendor/order_history/order_history_View', '' . '&order_id=' . $this->request->get['order_id'] . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('vendor/order_history_view', $data));
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'] = array(
            ...
            array('text' => $this->language->get('heading_title'), 'href' => $this->url->link('vendor/order_history', '', true))
        );
        ...
        $vendor_id = $this->vendor->getId();
        $order_total = $this->model_vendor_order_history->getTotalCompleteOrders($vendor_id, $filter_data);
        $results = $this->model_vendor_order_history->getCompleteOrders($vendor_id, $filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['order_history'][] = array(
				...
				'GSTIN' => $result['fax'],
                'view' => $this->url->link('vendor/order_history/order_history_View', 'order_id=' . $result['order_id'], true)
            );
        }
        ...
        $pagination->url = $this->url->link('vendor/order_history', $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('vendor/order_history', $data));
    }
