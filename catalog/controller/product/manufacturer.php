...
// 			}
           ...
           //old -  // $this->document->addLink( $this->url->link('product/manufacturer/info', 'manufacturer_id=' . (int)$this->request->get['manufacturer_id'], true), 'canonical');
            
            // new added on 10-06-2025
            // Always set canonical URL to clean version (no pagination, sort, order, limit)
            $canonical_url = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . (int)$this->request->get['manufacturer_id'], true);
