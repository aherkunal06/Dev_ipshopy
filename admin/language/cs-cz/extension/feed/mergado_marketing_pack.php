...
$_['text_success']     = 'Úspěšně jste změnili nastavení modulu Mergado Pack!';
...
$_['mergado_url']      = 'https://www.mergado.cz/?utm_source=mp&utm_medium=logo&utm_campaign=mergado_pack';
...
$_['home_desc2']       = 'Exportujte svoje produkty a pomocí Mergado App je proměňte na stovky dalších XML formátů.'; 
...
//feed section
$_['feeds_text']       = 'Vložte následující XML odkazy do vašeho <a href="https://accounts.mergado.com/login/?utm_source=mp&utm_medium=button&utm_campaign=login" target="_blank">Mergado účtu</a>. V Mergado aplikaci můžete váš feed dále modifikovat a převádět na stovky dalších formátů.'; 
...
$_['support_text']     = 'V případě jakýchkoliv otázek nás neváhejte kontaktovat na <a href="mailto:opencart@mergado.cz">opencart@mergado.cz</a>.';
...
$_['license_text']     = 'Použití modulu Mergado Pack je pouze na vlastní riziko. Tvůrce modulu, společnost Mergado technologies, s.r.o., nenese odpovědnost za případné ztráty či vzniklé škody v jakékoliv podobě. Instalací modulu do vašeho e-shopu s tímto souhlasíte.<br/><br/>Modul není možné měnit zásahem do zdrojových kódů či upravovat jinak než uživatelským nastavením v administraci OpenCart.<br/></br>Používání modulu Mergado Pack pro OpenCart je zdarma. Podporované verze jsou od 3.0.0.0. výš.';
...
//sidebar section
$_['sidebar_recommend_heading']  = 'Mergado Pack doporučuje'; 
